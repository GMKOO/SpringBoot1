...
<header class="masthead">
            ...
            <th class="col-1">읽음 </th>
             ...
             <tbody>
                      ...
                      <c:forEach items="${list }" begin="1" end="10" var="row"> 
            <tr class="row detail">
            <td class="col-1">${row.bno} </td>
            <td class="col-6 title">${row.btitle} 
            ...
            <td class="col-1">${row.blike } </td>
             ...
             <button type="button" id="modal1" class="btn bin-success" data-bs-toggle="modal" data-bs-target="#exampleModal"> 모달</button>

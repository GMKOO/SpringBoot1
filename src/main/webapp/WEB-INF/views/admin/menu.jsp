<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		<div class="menu">
			...
			<div class="menu-item" onclick="url('comment')"><i class="xi-comment-o xi-2x"></i>공기질관리</div>
			<div class="menu-item" onclick="url('message')"><i class="xi-message-o xi-2x"></i>코로나</div>
